...
pub struct SignatureGenerator {
    ...
    spread_fft_outputs: Vec<Vec<f32>>, // 1025] 256],
    /// Ring buffer.
...
impl SignatureGenerator {
    ...
    fn do_peak_spreading(&mut self) {
        ...
        let spread_fft_results_copy = spread_fft_results.to_vec(); // Avoid mutable+mutable borrow of self.spread_fft_outputs
